...
PERPLEXITY_MODELS = [
    ('sonar', 'Sonar (Online, fast)'),
    ('sonar-pro', 'Sonar Pro (Online, deep retrieval)'),
    ('sonar-reasoning-pro', 'Sonar Reasoning Pro (Chain-of-thought)'),
    ('sonar-deep-research', 'Sonar Deep Research (Exhaustive synthesis)'),
]
